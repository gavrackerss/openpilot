...
public class TeslaFullCflashS19ExporterV16 extends GhidraScript {
    ...
    protected void run() throws Exception {
        ...
        File binFile = new File(outputDirectory, "Tesla_MCU1_ConfigAckFailure.bin");
        File s19File = new File(outputDirectory, "Tesla_MCU1_ConfigAckFailure.S19");
        File reportFile = new File(outputDirectory, "Tesla_MCU1_ConfigAckFailure_export_report.txt");
