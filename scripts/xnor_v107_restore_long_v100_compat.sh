...
SRC_PATH="$ROOT/xnor_v107_payload/openpilot/selfdrive/car/modules/LONG_module_v100_compat.py"
BACKUP_ROOT="$ROOT/.xnor_backups"
BACKUP_DIR="$BACKUP_ROOT/v107_restore_long_v100_compat_$(date +%Y%m%d_%H%M%S)"
...
echo "OK restored LONG_module.py to v100/v102 + CruiseButtons fallback"
